...
return [
    'label' => [
        ...
        'contact_identity_section' => 'Identity',
        'contact_identity_description' => 'Counterparty type and the name used across the system. The name can be filled in each available language.',
        'contact_details_section' => 'Identification & Contact',
        'contact_details_description' => 'Tax ID, phone, email, and whether the contact is visible to other users.',
        'inn' => 'INN',
        'pinfl' => 'PINFL',
        'phone' => 'Phone',
