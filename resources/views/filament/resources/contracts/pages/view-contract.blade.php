@php
    ...
    // Execution history: dedupe near-identical events, group by day (newest first).
...
<x-filament-panels::page>
    <style>
        ...
        /* hero */
        .cw-hero{ display:flex; align-items:center; gap:1.1rem; flex-wrap:wrap; background:var(--s);
            border-radius:1rem; padding:1rem 1.25rem; box-shadow:0 0 0 1px var(--r), 0 1px 2px rgba(0,0,0,.04); }
        .cw-hero__cur{ display:flex; align-items:center; gap:.6rem; padding-left:1.1rem; margin-left:.1rem; border-left:1px solid var(--d); }
        .cw-hero__cur img{ width:2.1rem; height:2.1rem; border-radius:999px; object-fit:cover; box-shadow:0 0 0 2px #f59e0b; }
        .cw-hero__lbl{ font-size:.68rem; color:var(--m2); text-transform:uppercase; letter-spacing:.04em; }
        ...
        .cw-hero__num{ font-size:.78rem; font-weight:650; color:var(--m); white-space:nowrap; }
        .cw-bar{ width:8.5rem; height:.45rem; border-radius:999px; background:var(--track); overflow:hidden; }
        .cw-bar>span{ display:block; height:100%; border-radius:999px; background:linear-gradient(90deg,#34d399,#10b981); transition:width .45s ease; }
        ...
        .cw-pill--lg{ padding:.34rem .85rem; font-size:.78rem; }
        ...
        .cw-chain{ padding:.85rem 1.25rem 1.1rem; }
        .cw-step{ position:relative; display:flex; align-items:flex-start; gap:.9rem; padding:.55rem .6rem; border-radius:.8rem; transition:background .15s; }
        .cw-step:not(:last-child){ margin-bottom:.15rem; }
        .cw-step:not(:last-child)::before{ content:''; position:absolute; left:1.95rem; top:2.85rem; bottom:-.45rem; width:2px; background:var(--track); border-radius:2px; }
        .cw-step--approved:not(:last-child)::before{ background:#86efac; }
        .cw-step--current{ background:linear-gradient(90deg, rgba(245,158,11,.07), transparent 70%); }
        .cw-node{ position:relative; flex-shrink:0; }
        .cw-node img{ width:2.7rem; height:2.7rem; border-radius:999px; object-fit:cover; display:block; box-shadow:0 0 0 2px var(--s), 0 0 0 3px var(--track); }
        ...
        .cw-badge{ position:absolute; bottom:-.25rem; right:-.25rem; width:1.35rem; height:1.35rem; border-radius:999px; display:flex; align-items:center; justify-content:center; box-shadow:0 0 0 2px var(--s); color:#fff; }
        ...
        .cw-step__bd{ min-width:0; flex:1; padding-top:.1rem; }
        .cw-step__nm{ font-size:.9rem; font-weight:650; color:var(--t); display:flex; align-items:center; gap:.4rem; }
        .cw-ord{ font-size:.66rem; font-weight:700; color:var(--m2); background:var(--soft); border-radius:999px; padding:.05rem .4rem; }
        .cw-step__dp{ font-size:.78rem; color:var(--m); margin-top:.1rem; }
        .cw-step__meta{ display:flex; align-items:center; gap:.6rem; margin-top:.45rem; flex-wrap:wrap; }
        ...
        .cw-cmt{ margin-top:.5rem; padding:.45rem .7rem; border-radius:.55rem; background:var(--soft); font-size:.78rem; color:var(--m); border:1px solid var(--d); }
        ...
        .cw-more>summary{ list-style:none; padding:.5rem .6rem; cursor:pointer; font-size:.78rem; color:var(--m); display:flex; align-items:center; gap:.4rem; user-select:none; border-radius:.6rem; }
        ...
        .cw-row{ display:flex; align-items:center; gap:.7rem; padding:.8rem 1.25rem; border-bottom:1px solid var(--d); }
        .cw-row__ic{ color:var(--m2); display:inline-flex; flex-shrink:0; }
        .cw-row__lb{ font-size:.78rem; color:var(--m); width:42%; flex-shrink:0; }
        .cw-row__vl{ font-size:.85rem; font-weight:550; color:var(--t); min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }

        /* execution timeline */
        .cw-day{ position:relative; }
        ...
        .cw-tl__ds{ font-size:.85rem; font-weight:600; color:var(--t); }
        .cw-tl__mt{ font-size:.74rem; color:var(--m2); margin-top:.12rem; display:flex; align-items:center; gap:.4rem; flex-wrap:wrap; }
        ...
        .cw-kv__vl{ font-size:.85rem; font-weight:550; color:var(--t); }
        ...
        .cw-mini__ds{ font-size:.82rem; font-weight:550; color:var(--t); }
        ...
        <div class="cw-hero">
            ...
            @if ($totalCount > 0)
                <div class="cw-hero__prog">
                    <span class="cw-hero__num">{{ $approvedCount }} / {{ $totalCount }} {{ __('app.label.approved_lower') }}</span>
