...
@once
    <style>
        ...
        .cf-file__field{ display:flex; flex-direction:column; gap:.15rem; min-width:0; }
        .cf-file__lb{ font-size:.62rem; font-weight:700; text-transform:uppercase; letter-spacing:.06em; color:#94a3b8; }
        .cf-file__vl{ font-size:.86rem; font-weight:650; color:currentColor;
