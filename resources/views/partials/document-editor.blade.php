...
<body>
    <div class="editor-shell">
        <div class="editor-topbar">
            ...
            <span class="status-pill" style="background: {{ $pill['bg'] }}; color: {{ $pill['fg'] }};">{{ $statusLabel }}</span>
        </div>
    ...
    <script>
        function closeEditor(event) {
            ...
            // Return to the opener (index or record view) when usable, else the fallback.
