...
<head>
    ...
    <title>{{ $template->name }} — {{ __('app.label.contract_template_single') }}</title>
    <style>
...
<body>
    <div class="editor-shell">
        <div class="editor-topbar">
            ...
            <div class="doc-meta">
                <span class="doc-number">{{ $template->name }}</span>
                <span class="doc-title">{{ strtoupper($template->language) }}</span>
            </div>

            <span class="status-pill">{{ __('app.label.contract_template_single') }}</span>
        </div>
    ...
    <script>
        function closeEditor(event) {
            ...
            // Fall back to the resource index when there's no usable referrer.
